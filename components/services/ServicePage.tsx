...
export function ServicePage({ service }: { service: ServiceContent }) {
  const serviceSchema = { "@context": "https://schema.org", "@type": "Service", name: service.pageTitle, description: service.metaDescription, url: `https://asapauto.com.au/services/${service.slug}`, provider: { "@type": "AutoRepair", name: "ASAP Auto Electrics", telephone: "+61398722722", address: { "@type": "PostalAddress", streetAddress: "Unit 3/3 Oban Rd", addressLocality: "Ringwood", addressRegion: "VIC", postalCode: "3134", addressCountry: "AU" } }, areaServed: "Melbourne eastern and outer-eastern suburbs" };
