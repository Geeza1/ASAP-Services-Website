...
export function ServicePage({ service }: { service: ServiceContent }) {
  const serviceSchema = { "@context": "https://schema.org", "@type": "Service", name: service.pageTitle, description: service.metaDescription, url: `https://www.asapautoelectrics.com.au/services/${service.slug}`, provider: { "@type": "AutoRepair", name: "ASAP Auto Electrics", telephone: "+61398702722", address: { "@type": "PostalAddress", streetAddress: "Unit 3/3 Oban Rd", addressLocality: "Ringwood", addressRegion: "VIC", postalCode: "3134", addressCountry: "AU" } }, areaServed: "Melbourne eastern and outer-eastern suburbs" };
  const breadcrumbSchema = { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://www.asapautoelectrics.com.au/" }, { "@type": "ListItem", position: 2, name: "Services", item: "https://www.asapautoelectrics.com.au/#services" }, { "@type": "ListItem", position: 3, name: service.shortTitle, item: `https://www.asapautoelectrics.com.au/services/${service.slug}` }] };
